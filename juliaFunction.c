...
extern int __pyx_module_is_main_juliaFunction;
int __pyx_module_is_main_juliaFunction = 0;

/* Implementation of 'juliaFunction' */
...
static PyObject *__pyx_f_13juliaFunction_juliaSet(int __pyx_v_mouseX, int __pyx_v_mouseY, int __pyx_v_width, int __pyx_v_height, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  float __pyx_v_complexX;
  float __pyx_v_complexY;
  float __pyx_v_cx;
  float __pyx_v_cy;
  float __pyx_v_temporaryValue;
 ...
 *     return iterationArray
 */
      (__pyx_v_iterationArray[(__pyx_v_x + (__pyx_v_y * 0x190))]) = __pyx_v_iterations;
    }
  }
...
/* Python wrapper */
static PyObject *__pyx_pw_13juliaFunction_1juliaSet(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_13juliaFunction_1juliaSet(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_mouseX;
  int __pyx_v_mouseY;
  int __pyx_v_width;
  int __pyx_v_height;
  ...
  __Pyx_RefNannySetupContext("juliaSet (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_mouseX)) != 0)) kw_args--;
...
static PyMethodDef __pyx_methods[] = {
  {"juliaSet", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13juliaFunction_1juliaSet, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_juliaFunction(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_juliaFunction},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initjuliaFunction(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initjuliaFunction(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_juliaFunction(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_juliaFunction(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_juliaFunction(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'juliaFunction' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_juliaFunction(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("juliaFunction", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_juliaFunction) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "juliaFunction")) {
      if (unlikely(PyDict_SetItemString(modules, "juliaFunction", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init juliaFunction", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init juliaFunction");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
